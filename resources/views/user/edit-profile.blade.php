        <!-- Modal Edit Profil -->
        <div id="editProfileModal" class="fixed inset-0 bg-black bg-opacity-10 flex items-center justify-center z-50 hidden p-3 my-3">
                ...
                <form id="editProfileForm" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="text-black">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-col items-center justify-center border border-gray-300 rounded p-4">
                            <!-- Preview -->
                            <img id="profileImagePreview" src="" alt="Preview" class="w-24 h-24 rounded-full object-cover border mb-2 hidden" />
                    ...
                    <div class="flex justify-end mt-6">
                        <button type="button" onclick="closeModal('editProfileModal')" class="mr-2 px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 transition">Batal</button>
                        <button type="submit" class="px-4 py-2 bg-[#F17025] text-white rounded hover:bg-orange-600 transition">Simpan</button>
                    </div>
                </form>

                <!-- Close Icon -->
                <button onclick="closeModal('editProfileModal')" class="absolute top-2 right-4 text-gray-500 hover:text-black text-2xl">&times;</button>
            </div>
        </div>
