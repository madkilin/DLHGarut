                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex flex-wrap gap-1 items-center justify-center">
                                            ...
                                            @if ($complaint->status === 'diproses' && $complaint->proof)
                                                ...
                                                <a href="{{ route('admin.complaints.print.proof', $complaint->id) }}" target="_blank" class="btn bg-red-500 hover:bg-red-600 text-white px-3 py-1 text-xs rounded-lg shadow transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-300 w-30">
