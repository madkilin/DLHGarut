                ...
                <table id="exchangePoint" class="min-w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left text-sm font-semibold" width="15%">Tanggal Penukaran</th>
                            <th class="text-left text-sm font-semibold" width="15%">Tanggal Konfirmasi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $exchange->date }}</td>
                            <td>
                                @if ($exchange->date == $exchange->updated_at)
                                -
                                @else
                                {{ $exchange->updated_at }}
                                @endif
