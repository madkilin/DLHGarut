    ...
    <div class="flex flex-wrap gap-1 items-center justify-center">
        ...
        @else
            <button onclick="openModal('modal-status-{{ $complaint->id }}')"
                class="btn bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 text-xs rounded-lg shadow transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-300 w-20">
                Ubah Status
            </button>
        @endif
        ...
        @if ($complaint->status === 'diproses' && $complaint->proof)
            ...
            <a href="{{ route('admin.complaints.print.proof', $complaint->id) }}" target="_blank"
        ...
        @if ($complaint->status === 'terkirim')
            <a href="{{ route('admin.complaints.print', $complaint->id) }}" target="_blank"
        ...
        @if ($complaint->status === 'selesai')
            <a href="{{ route('admin.complaints.print.complete', $complaint->id) }}" target="_blank"
                class="btn bg-red-500 hover:bg-red-600 text-white px-3 py-1 text-xs rounded-lg shadow transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-300 w-30">
                Print Seluruh Data
            </a>
        @endif
