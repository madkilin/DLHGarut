                            ...
                            <td>
                                <div class="flex">
                                    <a href="{{ route('reward.show', $reward->id) }}"
                                        class="relative btn bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 text-xs rounded-lg shadow transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-300 w-20 mr-2">Lihat
                                    </a>
                                    <a href="{{ route('reward.edit', $reward->id) }}"
                                        class="relative btn bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 text-xs rounded-lg shadow transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-300 w-20 mr-2">Edit
                                    </a>
