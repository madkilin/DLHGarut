    ...
    <div id="mobile-menu" class="hidden md:hidden absolute top-16 left-0 w-full bg-white text-[#007546] px-4 py-6 z-40 space-y-4 transition-all duration-300">
        ...
        <!-- <div class="border-t border-[#007546]/90 my-4 pt-4">
            <div class="mt-4 space-y-2">
                <a href="{{ route('user.profile') }}" class="block text-sm text-[#007546] hover:text-[#F17025]">Lihat Profil</a>
            </div>
        </div> -->
        @endauth
        <a href="/" class="block text-[#007546]/90 hover:text-[#F17025]">Home</a>
        <a href="/dashboard" class="block text-[#007546]/90 hover:text-[#F17025]">Dashboard</a>
        ...
        <a href="/article/list" class="block text-[#007546]/90 hover:text-[#F17025]">Manajemen Artikel</a>
        <a href="{{ route('user.profile') }}" class="block text-[#007546]/90 hover:text-[#F17025]">Lihat Profil</a>
        <a href="{{ route('exchange-point.index') }}" class="block text-[#007546]/90 hover:text-[#F17025]">Riwayat Penukaran</a>
        <a href="{{ route('progress-log.index') }}" class="block text-[#007546]/90 hover:text-[#F17025]">Progress Log</a>
        @auth
