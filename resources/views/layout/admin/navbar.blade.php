<nav id="navbar"
    ...
    <div class="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex space-x-8 items-center">
            ...
            <a href="#" class="text-lg hover:text-[#F17025] transition-colors">Manajemen Pengguna</a>
            <a href="#" class="text-lg hover:text-[#F17025] transition-colors">Manajemen Pengaduan</a>
