...
<section id="artikel" class="relative bg-gradient-to-br from-white via-green-50 to-white py-24 overflow-hidden">
  <div class="container mx-auto px-6 md:px-16">
    ...
    <div class="text-center mb-16">
      ...
      <p class="text-gray-600 text-lg max-w-2xl mx-auto">Dapatkan informasi terkini dan bermanfaat seputar lingkungan,
        pengelolaan sampah, dan kegiatan DLH Garut.</p>
    </div>

    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-20">
      @foreach ($highlightArticles as $item)
      <div
        class="bg-white rounded-2xl shadow-xl overflow-hidden transition hover:shadow-2xl hover:scale-[1.01] duration-300">
        ...
        <div class="p-6">
          ...
          <a href="{{ route('artikel.show', $item->slug) }}" class="text-[#F17025] font-semibold hover:underline">Baca
            Selengkapnya →</a>
        </div>
      </div>
      @endforeach
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div
        class="bg-white rounded-xl shadow-md overflow-hidden transition hover:shadow-lg hover:scale-[1.01] duration-300">
        ...
        <div class="p-4">
          ...
          <a href="{{ route('artikel.show', $item->slug) }}"
            class="text-[#F17025] text-sm font-semibold hover:underline">Baca Selengkapnya →</a>
        </div>
      </div>
      @endforeach
    </div>
    @else
    <div class="py-15">
      <p class="text-center text-gray-500 text-lg font-medium">Maaf, artikel dengan judul atau penulis yang Anda cari
        tidak ditemukan.</p>
    </div>
    @endif
    ...
    <div class="mt-10 flex justify-center">
      ...
      <nav class="inline-flex shadow-sm rounded-lg overflow-hidden" role="navigation">
        ...
        <a href="{{ $articles->previousPageUrl() }}"
          class="px-4 py-2 text-[#007546] hover:bg-green-50 border border-gray-200">«</a>
        @endif
